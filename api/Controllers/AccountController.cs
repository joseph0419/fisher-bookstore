...
namespace Fisher.Bookstore.Api.Controllers
{
    ...
    public class AccountController : ControllerBase{
        ...
        [HttpPost("register")]
        public async Task<IActionResult> Register([FromBody] ApplicationUser registeration)
        {
        ...
        public async Task<IActionResult> Login([FromBody] ApplicationUser login)
        {
            ...
            login.Password, isPersistent: false, lockoutFailure: false);
            if (!result.Succeeded)
            {
                return Unauthorized();
            }
        ...
        ("JWTConfiguration: Key"));
            ...
            var token = new JwtSecurityToken(
                ...
                signingCredentials: new SigningCredentials(new SymmetricSecurityKey(signingKey), SecurtiyAlgorithms.HmacSha256));
                return token;
        }
